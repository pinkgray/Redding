...
@WebServlet("/QnAComplete.no")
public class MemberQnACompleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public MemberQnACompleteServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<HashMap<String, Object>> QnAList = new BoardService().selectQnAComplete(pi);
