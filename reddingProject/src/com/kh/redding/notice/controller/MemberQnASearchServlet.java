...
@WebServlet("/searchQnA.no")
public class MemberQnASearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public MemberQnASearchServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("type :" + searchType  + ", text :" + searchText);
		...
		// 페이징 추가
				...
				ArrayList<HashMap<String, Object>> QnAList = new BoardService().selectQnASearch(pi,searchType,searchText);
