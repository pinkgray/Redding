...
@WebServlet("/ManyLike.bo")
public class ManyBoardLikeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public ManyBoardLikeServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//페이징 처리 후
		ArrayList<HashMap<String, Object>> list = new BoardService().selectManyLike(pi);
